...
| [GitHub Actions CI/CD](./terraform-labs/) | CI/CD pipeline, automated Terraform validation, GitHub Secrets | ✅ Complete |
...
| [ECS Lab](./docker-lab/ecs-lab/) | ECR, ECS Fargate, task definitions, services, security groups | ✅ Complete |

---

## Flagship Capstone Project

### [Containerized Web App with Full CI/CD Pipeline](https://github.com/nainashee/aws-capstone-cicd)

A production-style deployment pipeline — every push to GitHub automatically builds, pushes, and redeploys a containerized web app on AWS. No manual steps.

```
git push → GitHub Actions → Docker build → ECR push → ECS redeploy → Live in ~30 seconds
```

**Services:** Terraform · Docker · ECR · ECS Fargate · GitHub Actions · VPC · IAM
...
- **CI/CD:** GitHub Actions — automated pipelines, secrets management, ECS deployment
- **Containers:** Docker — images, containers, Dockerfile, ECR, ECS Fargate
...
- 🚀 [Flagship Capstone](https://github.com/nainashee/aws-capstone-cicd)
